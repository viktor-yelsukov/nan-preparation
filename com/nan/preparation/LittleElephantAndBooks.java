...
You are given a int[] pages. Each element of pages is the number of pages in one of those books. 
...
Little Elephant knows that the other elephants are lazy: they will simply pick the shortest number books, 
so that they have to read the smallest possible total number of pages. 
...
public class LittleElephantAndBooks {
	...
	public static void main(String[] args) {
	  LittleElephantAndBooks solution = new LittleElephantAndBooks();
	  
	  System.out.println(solution.getNumber(new int[] {1, 2}, 1));
	  System.out.println(solution.getNumber(new int[] {74, 7, 4, 47, 44}, 3));
	  System.out.println(solution.getNumber(new int[] {3, 1, 9, 7, 2, 8, 6, 4, 5}, 7));
	  System.out.println(solution.getNumber(new int[] {74, 86, 32, 13, 100, 67, 77}, 2));
    }

	private int getNumber(int[] pages, int numBooks) {
        // Solution goes here.
	}
}

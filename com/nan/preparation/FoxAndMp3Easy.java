...
/**
 * Problem Statement
    	Fox Ciel loves music. She currently has n songs in her mp3 player. 
...
If n is at most 50, return a String[] containing the entire sorted list of file names. 
...
1. A is a proper prefix of B; 2. There is an index i such that the first (i-1) characters of A and B are equal, 
...
public class FoxAndMp3Easy {
  public static void main(String[] args) {
	  FoxAndMp3Easy solution = new FoxAndMp3Easy();
	  System.out.println(print(solution.playList(3)));
	  System.out.println(print(solution.playList(10)));
	  System.out.println(print(solution.playList(16)));
	  System.out.println(print(solution.playList(32)));
	  System.out.println(print(solution.playList(109)));
  }
  
  /**
   *  Helper method to print out the array.
   */
  private static String print(String[] playList) {
  ...
  public String[] playList(int songs) {
